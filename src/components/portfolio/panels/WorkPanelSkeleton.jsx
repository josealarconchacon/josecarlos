  ...
  return (
    <article className="flex flex-col gap-10 px-1">
      {WORK_PROJECTS.map((project, index) => (
        ...
        >
          <div className="flex flex-col gap-4 @[400px]:flex-row @[400px]:items-start @[400px]:gap-6">
            {project.image ? (
              <div className="min-w-0 w-full shrink-0 overflow-hidden rounded-xl border border-white/10 bg-white/[0.04] ring-1 ring-white/5 @[400px]:max-w-[min(100%,20rem)] @[400px]:basis-[42%]">
                <img
              ...
              <div className="flex aspect-[16/10] w-full min-w-0 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-portfolio-accent/20 via-portfolio-bg to-portfolio-accent-hover/10 ring-1 ring-white/5 @[400px]:max-w-[min(100%,20rem)] @[400px]:basis-[42%]">
                <ClipboardList
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex flex-wrap gap-2.5 pt-1 @[400px]:pt-3">
                <a
                  href={project.links.repo}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-lg border border-white/30 bg-transparent px-4 py-2.5 font-manrope text-sm font-semibold text-white transition duration-300 hover:border-portfolio-accent hover:text-portfolio-accent active:scale-95 @[400px]:flex-none @[520px]:min-w-[9rem]"
                >
